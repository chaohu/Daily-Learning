function expt6_1(action)
% EXPT6_1 Run the first subtopic in experiment6
% 
% Type "expt6_1" at the command line to browse the experiment.
% With the optional parameter
% EXPT6_1 draw the specified figure out.
%
...
case 'runexpt'
   ...
   [num1,len1]=poly2str(b,'z');
   [den2,len2]=poly2str(a,'z');
   len=max(len1,len2);
...
set(H0,'Name','实验六  离散系统的Z域分析——离散系统的Z域分析');
...
set(H_run,'callback','expt6_1 runexpt');
H_help=findobj(gcf,'Tag','Help');
set(H_help,'callback','expt6_1 runhelp');
...
myhelp
set(gcf,'Name',data(6,1).helpname);
set(findobj(gcf,'Tag','HelpList'),'String',data(6,1).helptext);
