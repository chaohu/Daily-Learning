...
%   $Revision: 1.19 $  $Date: 1998/09/18 17:58:04 $
   ...
   for k=1:prod(sizes(3:end)),
      ...
      while j<=nu,
         ...
         [sys.z{i,j,k},sys.p{i,j,k},sys.k(i,j,k)] = ...
                inprod(sys1.z(i,:,k),sys1.p(i,:,k),sys1.k(i,:,k),...
...
function [z,p,k] = inprod(z1,p1,k1,z2,p2,k2)
%INPROD  Inner product of two vectors of SISO ZPK models
%
%      [Z,P,K] = INPROD(Z1,P1,K1,Z2,P2,K2) returns the ZPK
