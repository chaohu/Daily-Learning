...
%   $Revision: 1.12.1.2 $  $Date: 1999/01/05 12:08:51 $
...
case 'lti'
   ...
   DisplayStr = {...
         ...
         '                 Default value:  0.'...
         '  '...
         ' ioDelayMatrix - I/O delays (transport delays between inputs and outputs).'...
         ...
         '                 Assignable values:  Cell array G where'...
         '                   * G{i,1} = vector of channel indices for Group #i'...
         '                   * G{i,2} = name for Group #i (string).'...
         '                 Example:  {[1 2] ''controls'' ; [3 5] ''noise''}'...
         '                 Default value:  0-by-2 empty cell.'...
         '  '...
         ' OutputGroup   - Groups of output channels.'...
         '                 Content:  M-by-2 cell array when M output groups'...
         '                 Assignable values:  Same as for InputGroup.'...
         '  '...
         ' Notes         - User''s notes.'...
