...
%   $Revision: 1.6 $  $Date: 1999/01/05 12:08:50 $
...
case 'frd'
   ...
   DisplayStr = {...
         ...
         '   points in FRD models by using the keyword ''frequency'', as shown in' ...
         '   the following examples:' ...
         '      sys(''Frequency'',sys.Frequency>100)' ...
         '   extracts the FRD consisting of the frequency points from sys' ...
         '   above 100 (in units of sys.Units), for all inputs/outputs.' ...
         '      sys(:,1:2,''Frequency'',sys.Frequency(1:10))' ...
         '   extracts the FRD containing only the first 10 frequency points' ...
         '   from sys, from the first two input channels to all output channels.' ...
         '   Note that indexing by boolean expression and by frequency value' ...
         '   are both supported.  See the Control System Toolbox User''s Guide' ...
