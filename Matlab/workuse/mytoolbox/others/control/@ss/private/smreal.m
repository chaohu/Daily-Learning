function [A,B,C,E,StateNames] = smreal(A,B,C,E,StateNames)
...
%   The argument NAMES contains the state names.

%   Author(s): P. Gahinet
%   Copyright (c) 1986-98 by The MathWorks, Inc.
%   $Revision: 1.1 $  $Date: 1998/05/05 13:56:17 $
...
% Dimensionality
sizes = size(A);
Colons = repmat({':'},[1 length(sizes)-2]);
