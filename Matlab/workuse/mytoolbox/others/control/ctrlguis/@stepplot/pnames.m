...
% Step Response (stepresp)-specific public properties
Props = {'PeakResponse';
   'PeakResponseValue';
   'RiseTime';
   'RiseTimeLimits';
...
if nargout<=1,
   ...
   AsgnVals = {'string (''on'',{''off''})'; ...
               ...
               'cell array of rise time values for each plotted system'; ...
               'string (''on'',{''off''})'; ...
               'percent limit for settling time calculation';...
               'cell array of settling time values for each plotted system'; ...
               'string (''on'',{''off''})'; ...
               'cell array of steady state values for each plotted system'};
