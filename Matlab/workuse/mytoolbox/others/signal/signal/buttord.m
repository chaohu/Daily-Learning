...
%   $Revision: 1.2 $  $Date: 1998/06/29 19:25:35 $
...
elseif ftype == 3	% stop
	...
	wp1 = fminbnd('bscost',WP(1),WS(1)-1e-12,fo,1,WP,WS,rs,rp,'butter');
	WP(1) = wp1;
	wp2 = fminbnd('bscost',WS(2)+1e-12,WP(2),fo,2,WP,WS,rs,rp,'butter');
	WP(2) = wp2;
